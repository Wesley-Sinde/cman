                ...
                <div class="span12" id="content">
                     <div class="row-fluid">
                        ...
                        <div class="block">
							...
							<h3></i><i class="icon-group"></i>&nbsp;Software Developer</h3>
							<hr>
							<div class="span3"></div>
                                <p align="center">
                                ...
                                <div class="span3" >
										<center>
								        <img id="developers" src="developers/j1.jpg" class="img-circle">
								        <hr>
										<p>Name: Lynn Obadha</p>
										<p>Address:Kenyatta University</p>
										<p>Email:<a href="http://www.gmail.com"> tutahf@gmail.com</a></p>
										<p>Position: Student - Computer Science </p>
										<p>Mobile:+2547 12347352</p>
								        </center>
								</div>
								</p>
